...
<body>
    ...
    <h1 class="text-center mb-8">Edit Data</h1>
            ...
            <div class="card-body">
                <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="notelpon" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="+62.." value="{{ $data->notelpon}}">
                      </div>
